...
public class Wrapper_gjsairat001 implements QunarCrawler {

    public static void main(String[] args) {
        FlightSearchParam searchParam = new FlightSearchParam();
        searchParam.setDep("ORY");
        searchParam.setArr("AGA");
...
//                    , new NameValuePair("arrivee", arg0.getArr())
                    ...
                    , new NameValuePair("date_arrivee", getDate(arg0.getRetDate()))
                    , new NameValuePair("type_classe", "RAMALL")
                    , new NameValuePair("radio-type-aller", "R")
...
//                    , new NameValuePair("E_LOCATION_1",arg0.getArr().substring(arg0.getArr().indexOf("(")+1,arg0.getArr().length()-1))
                    ...
                    , new NameValuePair("B_DATE_2", arg0.getRetDate().replaceAll("-", "") + "0000")
